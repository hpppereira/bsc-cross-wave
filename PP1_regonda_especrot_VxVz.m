...
figure
plot(dir,h_mat,'-*'), title('Espectro horário para frequência de pico - 100 reg. (Vx,Vz)'),xlabel('Direção'),ylabel('Energia')
figure
plot(dir,ah_mat,'-*'), title('Espectro anti-horário para frequência de pico - 100 reg. (Vx,Vz)'),xlabel('Direção'),ylabel('Energia')
figure
plot(dir,d_mat,'-*'), title('Espectro da diferença para frequência de pico - 100 reg. (Vx,Vz)'),xlabel('Direção'),ylabel('Energia')
figure
plot(dir,cr_mat,'-*'), title('Coeficiente de Rotação para frequência de pico - 100 reg. (Vx,Vz)'),xlabel('Direção'),ylabel('Energia')
...
figure
plot(dir,h_med,'-*')
title('Espectro horário (média) - (Vx,Vz)'), xlabel('Direção'),ylabel('Energia')
hold on, plot(dir,dpp_h,'r--',dir,dpn_h,'r--'), hold off, legend('Média','Des. Pad')
figure
plot(dir,ah_med,'-*')
title('Espectro anti-horário (média) - (Vx,Vz)'), xlabel('Direção'),ylabel('Energia')
hold on, plot(dir,dpp_ah,'r--',dir,dpn_ah,'r--'), hold off, legend('Média','Des. Pad')
figure
plot(dir,d_med,'-*')
title('Espectro da diferença (média) - (Vx,Vz)'), xlabel('Direção'),ylabel('Energia')
hold on, plot(dir,dpp_d,'r--',dir,dpn_d,'r--'), hold off, legend('Média','Des. Pad')
figure
plot(dir,cr_med,'-*')
title('Coeficiente de rotação (média) - (Vx,Vz)'), xlabel('Direção'),ylabel('Energia')
hold on, plot(dir,dpp_cr,'r--',dir,dpn_cr,'r--'), hold off, legend('Média','Des. Pad')

figure
plot(dir,h_med,'-*',dir,ah_med,'-*')
title('Espectro horário e anti-horário (média) - (Vx,Vz)'),legend('espec. hor','espec. anti-hor'), xlabel('Direção'),ylabel('Energia')
