%% Calculo do espectro rotatorio nas componentes Vx e Vy para mar cruzado
...
title('Mar cruzado de 30 e 60 graus - VxVy')
ylabel('Energia')
...
title('Mar cruzado de 45 e 135 graus - VxVy')
ylabel('Energia')
legend('Auto-espec de Vx','Auto-espec de Vy','Espectro total')
axis tight
...
[aac]=Especrot(vxc,vyc,dt);

figure
subplot(3,1,1)
plot(aac(:,1),aac(:,2),'b'), hold on %autoespec de x
plot(aac(:,1),aac(:,3),'r')           %autoespec de z
plot(aac(:,1),aac(:,6),'g'), hold off %espectro total
title('Mar cruzado de 120 e 150 graus - VxVy')
ylabel('Energia')
legend('Auto-espec de Vx','Auto-espec de Vy','Espectro total')
axis tight
...
title('Espectro Rotatório - Mar cruzado de 30 e 60 graus - VxVy'), grid on, axis tight
...
title('Espectro Rotatório - Mar cruzado de 45 e 135 graus - VxVy'), grid on, axis tight
legend('Espec.total','Espec.horário','Espec.anti-horário')
subplot(2,2,2)
...
title('Espectro Rotatório - Mar cruzado de 120 e 150 graus - VxVy'), grid on, axis tight
legend('Espec.total','Espec.horário','Espec.anti-horário')
subplot(2,2,2)
