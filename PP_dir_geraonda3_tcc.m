%%%  Programa para cálculo da direção    %%%
%%%  de ondas geradas pela rotina        %%%
%%%  'geraonda3' utilizando o método PUV %%%

% Autor: Henrique Patrício P. Pereira %
...
cuu=aaxy(:,2); %auto-espec de U 
cvv=aaxy(:,3); %auto-espec de V 
cww=aaxz(:,3); %auto-espec de W 
cpp=aaxp(:,3); %auto-espec de P 
