...
%Gera um gráfico para cada onda
clear,clc,close all
...
for ii=1:nm
    ...
    subplot(3,1,2)
    plot(aa0(:,1),aa0(:,4))
    title('Espectro horário - (VyVz)'), ylabel('Energia'), axis tight

    subplot(3,1,3)
    plot(aa0(:,1),aa0(:,5))
    title('Espectro anti-horário - (VyVz)'),xlabel('Frequencia'), ylabel('Energia'), axis tight
    ...
    title('Espectro anti-horário - (VyVz)'), ylabel('Energia'), axis tight
    ...
    title('Coef. de Rotação - 0 graus - (VyVz)'), axis tight
    subplot(2,2,3)
    plot(aa0(:,1),aa0(:,9)),grid on %Direção da elipse
    title('Direção da elipse - 0 graus - (VyVz)'), axis tight
    subplot(2,2,4)
    ...
    title('Estabilidade da elipse - 0 graus - (VyVz)'), axis tight
    ...
    title('Coef. de Rotação - 30 graus - (VyVz)'), axis tight
    subplot(2,2,3)
    plot(aa30(:,1),aa30(:,9)),grid on %Direção da elipse
    title('Direção da elipse - 30 graus - (VyVz)'), axis tight
    subplot(2,2,4)
    plot(aa30(:,1),aa30(:,10)),grid on,hold on %Estabilidade da elipse
    plot(aa30(:,1),aa30(:,13),'r') %intervalo de confiança
    legend('Estabilidade da elipse','Intervalo de conf.')
    title('Estabilidade da elipse - 30 graus - (VyVz)'), axis tight
    ...
    title('Coef. de Rotação - 45 graus - (VyVz)'), axis tight
    subplot(2,2,3)
    plot(aa45(:,1),aa45(:,9)),grid on %Direção da elipse
    title('Direção da elipse - 45 graus - (VyVz)'), axis tight
    subplot(2,2,4)
    plot(aa45(:,1),aa45(:,10)),grid on,hold on %Estabilidade da elipse
    plot(aa45(:,1),aa45(:,13),'r') %intervalo de confiança
    legend('Estabilidade da elipse','Intervalo de conf.')
    title('Estabilidade da elipse - 45 graus - (VyVz)'), axis tight
    ...
    title('Coef. de Rotação - 60 graus - (VyVz)'), axis tight
    subplot(2,2,3)
    plot(aa60(:,1),aa60(:,9)),grid on %Direção da elipse
    title('Direção da elipse - 60 graus - (VyVz)'), axis tight
    subplot(2,2,4)
    plot(aa60(:,1),aa60(:,10)),grid on,hold on %Estabilidade da elipse
    plot(aa60(:,1),aa60(:,13),'r') %intervalo de confiança
    legend('Estabilidade da elipse','Intervalo de conf.')
    title('Estabilidade da elipse - 60 graus - (VyVz)'), axis tight
    ...
    title('Coef. de Rotação - 90 graus - (VyVz)'), axis tight
    subplot(2,2,3)
    plot(aa90(:,1),aa90(:,9)), grid on %Direção da elipse
    title('Direção da elipse - 90 graus - (VyVz)'), axis tight
    subplot(2,2,4)
    plot(aa90(:,1),aa90(:,10)), grid on, hold on %Estabilidade da elipse
    plot(aa90(:,1),aa90(:,13),'r') %intervalo de confiança
    legend('Estabilidade da elipse','Intervalo de conf.')
    title('Estabilidade da elipse - 90 graus - (VyVz)'), axis tight
    ...
    title('Coef. de Rotação - 135 graus - (VyVz)'), axis tight
    subplot(2,2,3)
    ...
    legend('Estabilidade da elipse','Intervalo de conf.')
    title('Estabilidade da elipse - 135 graus - (VyVz)'), axis tight
