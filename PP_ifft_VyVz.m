...
plot(reg0(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 0 graus')
subplot(3,2,3)
...
plot(reg30(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 30 graus')
subplot(3,2,3)
...
plot(reg60(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 60 graus')
subplot(3,2,3)
...
plot(reg90(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 90 graus')
subplot(3,2,3)
...
plot(reg120(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 120 graus')
subplot(3,2,3)
...
plot(reg135(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 135 graus')
subplot(3,2,3)
...
plot(reg150(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 150 graus')
subplot(3,2,3)
...
plot(reg180(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 180 graus')
subplot(3,2,3)
...
plot(rega(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 30+60 graus')
subplot(3,2,3)
...
plot(regb(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 45+135 graus')
subplot(3,2,3)
...
plot(regc(:,4)), hold off, legend('Vel y','Vel z'), axis tight, title('Série de Velocidades orbitais - 120+150 graus')
subplot(3,2,3)
