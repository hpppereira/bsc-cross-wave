...
%% para mar uni e bi-modal utilizando VxVz - utilizando a função FLIPUD (Muda para de onde a onda vem)
...
figure
subplot(3,2,1)
plot(aa30(:,1),aa30(:,4)), title('Espectro horário - 30 graus - VxVz'), hold all
...
figure
subplot(3,2,1)
plot(aa45(:,1),aa45(:,4)), title('Espectro horário - 45 graus - VxVz'), hold all
...
figure
subplot(3,2,1)
plot(aa120(:,1),aa120(:,4)), title('Espectro horário - 120 graus - VxVz'), hold all
...
figure
subplot(3,2,1)
plot(aa0(:,1),aa0(:,4)), title('Espectro horário - 0 graus - VxVz'), hold all
...
figure
subplot(3,2,1)
plot(aa150(:,1),aa150(:,4)), title('Espectro horário - 150 graus - VxVz'), hold all
plot(aa150(:,1),aa150(:,6)),legend('Espec horário','Espec total') ,hold off
subplot(3,2,3)
plot(aa180(:,1),aa180(:,4)), title('Espectro horário - 180 graus'), hold all
plot(aa180(:,1),aa180(:,6)),legend('Espec horário','Espec total') ,hold off
...
%% Cria gráfico de frequencias horárias (negativas) e horárias (positiva) - Gonella
% cria eixo x
...
plot(x,en_hah,'b-.','linewidth',1.5), hold off
...
plot(x,en_hah,'b-.','linewidth',1.5), grid on
legend('Espec. Total','Horário/Anti-Horário')
title('30 graus - Vx,Vz')
xlabel('Frequência (Hz)'), ylabel('(m/s)^2/Hz')
text(-0.5,13,'Espec. Horário (-)'),text(0.2,13,'Espec. Anti-Horário (+)')
...
plot(x,en_hah,'b-.','linewidth',1.5)
legend('Espec. Total','Horário/Anti-Horário')
title('180 graus - Vx,Vz')
xlabel('Frequência (Hz)'), ylabel('(m/s)^2/Hz')
text(-0.5,13,'Espec. Horário (-)'),text(0.2,13,'Espec. Anti-Horário (+)')
...
for i=1:n
    k=k+1;
    t=num2str(k);
    text(vxa(i,1),vza(i,1),['p',t])    
    text(vya(i,1),vza(i,1),['p',t])     
end
hold off
...
for i=1:n
    k=k+1;
    t=num2str(k);
    text(vxb(i,1),vzb(i,1),['p',t])    
    text(vyb(i,1),vzb(i,1),['p',t])     
end
hold off
...
for i=1:n
    k=k+1;
    t=num2str(k);
    text(vxc(i,1),vzc(i,1),['p',t])    
    text(vyc(i,1),vzc(i,1),['p',t])     
end
hold off
...
for i=1:n
    k=k+1;
    t=num2str(k);
    text(vxd(i,1),vzd(i,1),['p',t])    
    text(vyd(i,1),vzd(i,1),['p',t])     
end
hold off
...
for i=1:n
    k=k+1;
    t=num2str(k);
    text(vxe(i,1),vze(i,1),['p',t])    
    text(vye(i,1),vze(i,1),['p',t])     
end
hold off
...
for i=1:n
    k=k+1;
    t=num2str(k);
    text(vxf(i,1),vzf(i,1),['p',t])    
    text(vyf(i,1),vzf(i,1),['p',t])     
end
hold off
