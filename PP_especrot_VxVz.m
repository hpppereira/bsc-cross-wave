...
title('Espectro da diferença - 0 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,2)
plot(aa30(:,1),aa30(:,7)), axis tight
title('Espectro da diferença - 30 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,3)
plot(aa45(:,1),aa45(:,7)), axis tight
title('Espectro da diferença - 45 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,4)
plot(aa60(:,1),aa60(:,7)), axis tight
title('Espectro da diferença - 60 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,5)
plot(aa90(:,1),aa90(:,7)), axis tight
title('Espectro da diferença - 90 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,6)
plot(aa120(:,1),aa120(:,7)), axis tight
title('Espectro da diferença - 120 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,7)
plot(aa135(:,1),aa135(:,7)), axis tight
title('Espectro da diferença - 135 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,8)
plot(aa150(:,1),aa150(:,7)), axis tight
title('Espectro da diferença - 150 graus'), xlabel('Frequência'),ylabel('Energia')
subplot(3,3,9)
plot(aa180(:,1),aa180(:,7)), axis tight
title('Espectro da diferença - 180 graus'), xlabel('Frequência'),ylabel('Energia')
...
figure
subplot(2,2,1)
plot(dadosrot(:,1),dadosrot(:,3),'-*'), title('Espectro horário'), xlabel('Direção'),ylabel('Espec.hor')
subplot(2,2,2)
plot(dadosrot(:,1),dadosrot(:,4),'-*'), title('Espectro anti-horário'), xlabel('Direção'),ylabel('Espec.anti-hor')
subplot(2,2,3)
plot(dadosrot(:,1),dadosrot(:,5),'-*'), title('Espectro da diferença'), xlabel('Direção'),ylabel('Espec.dif')
subplot(2,2,4)
plot(dadosrot(:,1),dadosrot(:,6),'-*'), title('Coeficiente de rotação'), xlabel('Direção'),ylabel('Coef.Rot')
